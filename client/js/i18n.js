...
(function () {
  ...
  const DICT = {
    he: {
      ...
      'wa.button': '💬 אימות בוואטסאפ', 'wa.hint': 'נפתחת שיחה למספר של המערכת עם מילת אימות מוכנה — רק ללחוץ שליחה',
      'wa.waiting': 'ממתינים להודעה שלך בוואטסאפ…', 'wa.word': 'מילת האימות',
      'wa.privacy': 'המספר הזה משמש לזיהוי בלבד. מידע רפואי עובר ישירות בינך לבין הרופא/ה.',
      'wa.or': 'או לקבל קוד ב-SMS/וואטסאפ',
      'badge.new': 'תג חדש',
    ...
    en: {
      ...
      'wa.button': '💬 Verify on WhatsApp', 'wa.hint': 'Opens a chat to our number with a verification word ready — just hit send',
      'wa.waiting': 'Waiting for your WhatsApp message…', 'wa.word': 'Verification word',
      'wa.privacy': 'This number is used for identification only. Medical information goes directly between you and your doctor.',
      'wa.or': 'or get a code by SMS/WhatsApp',
      'badge.new': 'New badge',
    ...
    ar: {
      ...
      'wa.button': '💬 التحقق عبر واتساب', 'wa.hint': 'تُفتح محادثة إلى رقم النظام مع كلمة تحقق جاهزة — فقط اضغط إرسال',
      'wa.waiting': 'بانتظار رسالتك على واتساب…', 'wa.word': 'كلمة التحقق',
      'wa.privacy': 'هذا الرقم للتعريف فقط. المعلومات الطبية تنتقل مباشرة بينك وبين طبيبك.',
      'wa.or': 'أو استلام رمز عبر SMS/واتساب',
      'badge.new': 'وسام جديد',
    ...
    ru: {
      ...
      'wa.button': '💬 Подтвердить в WhatsApp', 'wa.hint': 'Откроется чат на номер системы с готовым словом — просто отправьте',
      'wa.waiting': 'Ждём ваше сообщение в WhatsApp…', 'wa.word': 'Слово для подтверждения',
      'wa.privacy': 'Этот номер используется только для идентификации. Медицинская информация идёт напрямую между вами и врачом.',
      'wa.or': 'или получить код по SMS/WhatsApp',
